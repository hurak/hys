...
For both options: simulate at least 5 minutes of reactor time from the given initial condition, and plot $T(t)$ together with the active mode $q(t)$ (and, if using Option 2, $\tau_1(t), \tau_2(t)$) to visually confirm the rod-preference and cooldown logic are behaving as intended.