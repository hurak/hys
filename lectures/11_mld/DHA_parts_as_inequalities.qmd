...
![Example of a discrete-time finite state machine (aka finite state automaton) modelled using binary variables](figures/fsm_example.png){width=60% #fig-fsm-example} 
...
Particularly useful from a computational viewpoint will be an affine function $f(x,u) = ax + bu + e$. We specialize the above inequalities to this case for later convenience.
$$\boxed{
\begin{aligned}
z &\leq M\delta,\\
- z &\leq -m\delta,\\
