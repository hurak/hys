...
![An automaton for a switched system](classes_figures/switched_system.png){width=50% #fig-switched-system}
...
- Under which conditions the solution is unique?

To answer both, the function $f()$ must be analyzed.

But before we answer the two questions, we must ask even more fundamental question: 

- What does it mean that a function $x(t)$ is a solution of the the ODE? 

However trivial this question may seem, it is not. There are actually several concepts of a solution of an orrdinary differential equation.
...
- Example of nonuniqueness is provided by
...
- It is a solution of the integral equation (indeed, an equation)
...
The system with discontinuous RHS
$$
\begin{aligned}
