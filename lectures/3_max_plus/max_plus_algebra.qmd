...
The inverse element with respect to $\otimes$ can exist, but not for all elements. The $\varepsilon$ element does not have an inverse element with respect to $\otimes$. But in this aspect the (max,+) algebra just follows the conventional algebra, because 0 has no inverse there either.
