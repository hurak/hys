...
![Example of a FSM](figures/fsm_example.png){width=60% #fig-fsm-example} 
...
z = \delta\,f(x,u),
$$
where $\delta$ is a binary indicator. This, in turn, can be written (finally using the equivalence for the [assignment](logic_vs_inequalities.qmd#assignment-product)) as
$$
\begin{aligned}
z &\leq M\delta,\\
- z &\leq -m\delta,\\
