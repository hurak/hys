...
![Hybrid automaton that is unstable due to switching even though the two modes are stable](figures/switching_between_stable.png){width=45% #fig-switching-between-stable}
...
![Hybrid automaton that is stable thanks to switching even though the two modes are unstable](figures/switching_between_unstable.png){width=45% #fig-switching-between-unstable}
