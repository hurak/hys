...
![Example of a production system modelled by a timed Petri net (both places and transitions are timed)](figures/production_system_petri_net.png){width=60% #fig-production_system_petri_net}
