...
- equivalently
$$\boxed{\pi_{i,k} = \tau_{j,k-x_{i,0}},\quad p_i\in \mathcal{O}(t_j).}$$
...
- For a timed transition with multiple input places
$$\boxed{
...
![Example of a Petri net for which the dynamics is analyzed](petri_nets_figures/timed_petri_net_dynamics.png){width=40%}
