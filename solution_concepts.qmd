...
::: {#exm-solution}
## Solution
En example of a solution is in @fig-solution-and-sets. Follow the solution with your finger and make sure you understand what and why is happening. In particular, in the overlapping region, the solution is not unique. While it can continue flowing, it can also jump.
