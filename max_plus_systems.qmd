...
bibliography: ref_complementarity.bib 
...
![Example of a production system modelled by a timed Petri net (only the transitions are timed)](max_plus_figures/production_system_petri_net_long.png){width=80% #fig-production_system_petri_net_long}
...
![Example of a production system modelled by a timed Petri net (both places and transitions are timed)](max_plus_figures/production_system_petri_net.png){width=65% #fig-production_system_petri_net}
...
Alternatively, there is a dedicated framework for solving these problem. It is called Extended Linear Complementarity Problem (ELCP) and was developed by @deschutterExtendedLinearComplementarity1995. We will introduce the complementarity problem(s) later in a [chapter dedicated to complementarity](complementarity_constraints.qmd).
