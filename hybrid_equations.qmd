...
- The variables staying constant between the jumps do flow too.
...
![Maps and sets for the bouncing ball example](hybrid_equations_figures/bouncing_ball_maps_and_sets.png){width=55%}
:::
...
![Example of a thyristor control](hybrid_equations_figures/thyristor_control.png){width=50%}
...
![Unicycle vehicle](hybrid_equations_figures/unicycle_stabilization.png){width=30%}
...
![Stabilization on a circle](hybrid_equations_figures/stabilization_on_a_circle.png){width=30%}
...
![Supervisory control](hybrid_equations_figures/supervisory_control.png){width=60%}
...
![Combining global and local controllers](hybrid_equations_figures/local_global_controllers.png){width=60%}
