...
Numerical methods for nonsmooth dynamical systems that are based on complementary constraints (and implemented in [SICONOS](https://nonsmooth.gricad-pages.univ-grenoble-alpes.fr/siconos/) software) are comprehensively presented in
@acaryNumericalMethodsNonsmooth2008 and @acaryNonsmoothModelingSimulation2011.
