...
We start with an *autonomous* (=no external/control inputs) *hybrid automaton* – it is a tuple of sets and (set) mappings 
$$
\boxed{
...
::: {.callout-caution}
Strictly speaking, $\mathcal{I}$ is a mapping and not a set. It is only the mapping evaluated at a given location $q$, that is, $\mathcal{I}(q)$ is a set.
:::    
...
Finally, $\mathcal R$ (or $r$) is not specified as the $x$ variable (the temperature) doesn't jump.

The graphical representation of the thermostat hybrid automaton is shown below.

![Hybrid automaton for a thermostat](hybrid_automata_figures/thermostat_automaton.png){width=60%}
...
![Automaton for a button controlled LED](hybrid_automata_figures/button_controlled_LED.png){width=80%}
...
![Water tank example](hybrid_automata_figures/water_tank.png){width=50%}
...
![Automaton for a water tank example](hybrid_automata_figures/water_tank_automaton.png){width=80%}
...
![Bouncing ball example](hybrid_automata_figures/bouncing_ball.png){width=25%}
...
![Hybrid automaton for a rimless wheel](hybrid_automata_figures/rimless_wheel_automaton.png){width=90%}
...
![Alternative hybrid automaton for a rimless wheel](hybrid_automata_figures/rimless_wheel_automaton_single_location.png){width=50%}
:::
...
![DC-DC boost converter: the switch closed](hybrid_automata_figures/dc_dc_boost_converter_mode_CLOSED.png){width=50%}
...
![DC-DC boost converter: continuous conduction mode (CCM)](hybrid_automata_figures/dc_dc_boost_converter_mode_CCM.png){width=50%}
...
![DC-DC boost converter: discontinuous conduction model (DCM)](hybrid_automata_figures/dc_dc_boost_converter_mode_DCM.png){width=50%}
...
![Hybrid automaton for a DC-DC boost converter](hybrid_automata_figures/dc_dc_boost_converter_automaton.png){width=80%}
