...
- Contrast the concept of a *(time-driven continuous-valued) dynamical system* with that of a *discrete-event system*.
...
- When introducing time into an automaton, which elements must be added into the (definition of the standard untimed) automaton to turn it into a *timed automaton*?
